...
void setup() {
  ...
  logfile.println("CPU time in ms, hh:mm:ss(UTC), temp, press, hum, lat, lng, alt, speed, course, distanceToStart, satellites");
  if (!logfile) {
#ifdef ENLOG
  ...
  Serial.println(filename);
  Serial.println("CPU time in ms, hh:mm:ss(UTC), temp, press, hum, lat, lng, alt, speed, course, distanceToStart, satellites");
#endif
  logfile.close();
